...
$db = new mysqli("localhost","root","","hospital");
    ...
    if(isset($_POST['sub']))
    {
        ...
        $query0="INSERT INTO medicine VALUES('$pass2','$pass3','$pass4','$pass5')";

        $query="INSERT INTO prescription VALUES('$id',1100,'$pass','$pass1')";

        $query2="INSERT INTO CONSISTS_OF VALUES('$id',1000, '$pass6')";

        if ($db->query($query0) === TRUE && $db->query($query) === TRUE && $db->query($query2) === TRUE) 
        {
    
            header("Location:prec.php?err=".urldecode("Sucessfully added"));
        }
        else
        {
            header("Location:prec.php?err=".urldecode("Unsucessful primary-key-error"));
            exit();
        }
    }
                    ...
                    <div class="panel-body">
                        <form method="post" role="form">
                            <fieldset>
                                    ...
                                    <div class="form-group">
                                    <h4>Medicine ID:</h4>
                                    <input class="form-control" type="number" id="pass2" name="pass1" requred>
                                    </div>
                                    <div class="form-group">
                                    <h4>Medicine Name:</h4>
                                    <input class="form-control" type="text" id="pass3" name="pass1" requred>
                                    </div>  
                                    <div class="form-group">
                                    <h4>Producer:</h4>
                                    <input class="form-control" type="text" id="pass4" name="pass1" requred>
                                    </div>
                                    <div class="form-group">
                                    <h4>Price:</h4>
                                    <input class="form-control" type="number" id="pass5" name="pass1" requred>
                                    </div>
                                    <h4>Quantity:</h4>
                                    <input class="form-control" type="number" id="pass6" name="pass1" requred>
                                    </div>
                                
                                    <h4>Preception Id:</h4>
                                    <input class="form-control" type="number" name="id" id="id" autofocus required>
                                    <div class="form-group">
                                    <h4>Doctor ID:</h4>
                                    <input class="form-control" type="number" id="pass" name="pass" requred>
                                    </div>
                                    <div class="form-group">
                                    <h4>Cost:</h4>
                                    <input class="form-control" type="number" id="pass1" name="pass1" requred>
                                    </div>
                                </div>
                                
                            
                                
                                 <button type="submit" class="btn btn-lg btn-success btn-block" id="sub" name="sub">Add Prescription</button>
                            </fieldset>
                        </form>
                        <br>
                    </div>
