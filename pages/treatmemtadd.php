...
$db = new mysqli("localhost","root","","hospital");
    ...
    if(isset($_POST['sub']))
    {
        ...
        $query="INSERT INTO treat VALUES('$id','$pass')";

        if ($db->query($query) === TRUE) 
        {
    
            header("Location:treatmemtadd.php?err=".urldecode("Sucessfully added"));
        }
        else
        {
            header("Location:treatmemtadd.php?err=".urldecode("Unsucessful Primary-or-foreign-key-error"));
            exit();
        }
    }
                        ...
                        <form method="post" role="form">
                            <fieldset>
                                ...
                                <div class="form-group">
                                 ...
                                 <button type="submit" class="btn btn-lg btn-success btn-block" id="sub" name="sub">Assign</button>
                            </fieldset>
                        </form>
                        <br>
                    </div>
