...
$db = new mysqli("localhost","root","","hospital");
    ...
    if(isset($_POST['sub']))
    {
        ...
        $query="INSERT INTO nurse VALUES('$id','$pass',13,'$pass1')";

        if ($db->query($query) === TRUE) 
        {
    
            header("Location:nursesadd.php?err=".urldecode("Sucessfully added"));
        }
        else
        {
            header("Location:nursesadd.php?err=".urldecode("Unsucessful primary-key-error"));
            exit();
        }
    }
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Nurse Details</h3>
                    </div>
                        ...
                        <form method="post" role="form">
                            <fieldset>
                                ...
                                <div class="form-group">
                                 ...
                                 <button type="submit" class="btn btn-lg btn-success btn-block" id="sub" name="sub">Add Nurse</button>
                            </fieldset>
                        </form>
                        <br>
                    </div>
