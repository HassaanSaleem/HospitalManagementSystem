...
$db = new mysqli("localhost","root","","hospital");
    ...
    if(isset($_POST['sub']))
    {
        ...
        $query="INSERT INTO deptt VALUES('$id','$pass')";

        if ($db->query($query) === TRUE) 
        {
    
            header("Location:addepartment.php?err=".urldecode("Sucessfully added"));
        }
        else
        {
            header("Location:addepartment.php?err=".urldecode("Unsucessful"));
            exit();
        }
    }
                        ...
                        <form method="post" role="form">
                            <fieldset>
                                ...
                                <div class="form-group">
                                 ...
                                 <button type="submit" class="btn btn-lg btn-success btn-block" id="sub" name="sub">Add Department</button>
                            </fieldset>
                        </form>
                        <br>
                    </div>
