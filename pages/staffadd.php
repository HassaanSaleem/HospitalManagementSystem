...
$db = new mysqli("localhost","root","","hospital");
    ...
    if(isset($_POST['sub']))
    {
        ...
        $query="INSERT INTO domestic_staff VALUES('$id','$pass',12,'$pass1')";

        if ($db->query($query) === TRUE) 
        {
    
            header("Location:staffadd.php?err=".urldecode("Sucessfully added"));
        }
        else
        {
            header("Location:staffadd.php?err=".urldecode("Unsucessful primary-key-error"));
            exit();
        }
    }
                        ...
                        <form method="post" role="form">
                            <fieldset>
                                ...
                                <div class="form-group">
                                 ...
                                 <button type="submit" class="btn btn-lg btn-success btn-block" id="sub" name="sub">Add Staff</button>
                            </fieldset>
                        </form>
                        <br>
                    </div>
