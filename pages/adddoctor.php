...
$db = new mysqli("localhost","root","","hospital");
    ...
    if(isset($_POST['sub']))
    {
        ...
        $query="INSERT INTO doctor VALUES('$id','$pass','$pass1','$pass2')";

        if ($db->query($query) === TRUE) 
        {
    
            header("Location:adddoctor.php?err=".urldecode("Sucessfully added"));
        }
        else
        {
            header("Location:adddoctor.php?err=".urldecode("Unsucessful-Primary-or-Froeign-Key-ERROR "));
            exit();
        }
    }
                    ...
                    <div class="panel-body">
                        <form method="post" role="form">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <h4>Doctor Salory:</h4>
                                    <input class="form-control" type="number" id="pass2" name="pass2" requred>
                                </div>
                                
                                
                                 <button type="submit" class="btn btn-lg btn-success btn-block" id="sub" name="sub">Add Doctor</button>
                            </fieldset>
                        </form>
                        <br>
                    </div>
